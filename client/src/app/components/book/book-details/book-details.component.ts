...
export class BookDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log("this.route.snapshot.paramMap.get('bookId');--",this.route.snapshot.paramMap.get('bookId'));
    
    this.bookId = this.route.snapshot.paramMap.get('bookId');
    this.isLogged = this.helperService.isLoggedIn();
    this.isAdmin = this.helperService.isAdmin();
    console.log("this.helperService.getProfile().id-",this.helperService.getProfile());
